...
(function() {
    var m = this,
        ...
        da = function(a,
            ...
            a.w = function(a, c, f) { for (var d = Array(arguments.length - 2), e = 2; e < arguments.length; e++) d[e - 2] = arguments[e]; return b.prototype[c].apply(a, d) }
        };
    /*
    ...
    var q = window,
        ...
        fa = function() {},
        ha = /\[native code\]/,
        v = function(a, b, c) { return a[b] = a[b] || c },
        ia = function(a) {
        ...
        na = /"/g,
        oa = /'/g,
        pa = function(a) { return String(a).replace(ka, "&amp;").replace(la, "&lt;").replace(ma, "&gt;").replace(na, "&quot;").replace(oa, "&#39;") },
        w = function() {
            var a;
            if ((a = Object.create) &&
                ha.test(a)) a = a(null);
        ...
        z = function(a, b) { a = a || {}; for (var c in a) x(a, c) && (b[c] = a[c]) },
        ra = function(a) { return function() { q.setTimeout(a, 0) } },
        A = function(a, b) { if (!a) throw Error(b || ""); },
        B = v(q, "gapi", {});
    var C = function(a, b, c) {
        ...
        D = function(a) {
            a = String(a);
            a = a.replace(ta, function(a) { try { return encodeURIComponent(a) } catch (f) { return encodeURIComponent(a.replace(/^[^%]+$/g, "\ufffd")) } }).replace(ua, function(a) { return a.replace(/%/g, "%25") }).replace(va, function(a) { return a.toUpperCase() });
            a = a.match(sa) || [];
            var b = w(),
                c = function(a) {
            ...
            d = function(a) { return c(a.replace(/\?/g, "%3F").replace(/#/g, "%23")) };
            b.query = a[5] ? [d(a[5])] : [];
            b.g = a[7] ? [d(a[7])] : [];
            return b
        },
        xa = function(a) { return a.w + (0 < a.query.length ? "?" + a.query.join("&") : "") + (0 < a.g.length ? "#" + a.g.join("&") : "") },
        ya = function(a, b) {
            var c = [];
            if (a)
                for (var d in a)
    ...
    var Ea = function(a, b, c, d) {
        ...
        Fa = function() { var a = t.readyState; return "complete" === a || "interactive" === a && -1 == navigator.userAgent.indexOf("MSIE") },
        Ia = function(a) {
            var b = Ga;
            if (!Fa()) try { b() } catch (c) {}
            Ha(a)
        ...
        Ha = function(a) {
            if (Fa()) a();
                ...
                q.addEventListener ? (q.addEventListener("load", c, !1), q.addEventListener("DOMContentLoaded", c, !1)) : q.attachEvent &&
                    (q.attachEvent("onreadystatechange", function() { Fa() && c.apply(this, arguments) }), q.attachEvent("onload", c))
            }
        },
        Ja = function(a) { for (; a.firstChild;) a.removeChild(a.firstChild) },
        Ka = { button: !0, div: !0, span: !0 };
    var F;
    F = v(q, "___jsl", w());
    v(F, "I", 0);
    v(F, "hel", 10);
    var La = function(a) { return F.dpo ? F.h : C(a, "jsh", F.h) },
        Ma = function(a) {
            var b = v(F, "sws", []);
            b.push.apply(b, a)
        },
        Na = function(a) { return v(F, "watt", w())[a] },
        Oa = function(a) {
            var b = v(F, "PQ", []);
            F.PQ = [];
            var c = b.length;
        ...
        Pa = function(a) { return v(v(F, "H", w()), a, w()) };
    var Qa = v(F, "perf", w()),
        Ra = v(Qa, "g", w()),
        Sa = v(Qa, "i", w());
    v(Qa, "r", []);
    w();
    w();
    var Ta = function(a, b, c) { var d = Qa.r; "function" === typeof d ? d(a, b, c) : d.push([a, b, c]) },
        G = function(a, b, c) {
            Ra[a] = !b && Ra[a] || c || (new Date).getTime();
            Ta(a)
        },
        Va = function(a, b, c) { b && 0 < b.length && (b = Ua(b), c && 0 < c.length && (b += "___" + Ua(c)), 28 < b.length && (b = b.substr(0, 28) + (b.length - 28)), c = b, b = v(Sa, "_p", w()), v(b, c, w())[a] = (new Date).getTime(), Ta(a, "_p", c)) },
        Ua = function(a) { return a.join("__").replace(/\./g, "_").replace(/\-/g, "_").replace(/,/g, "_") };
    var Wa = w(),
        H = [],
        J = function(a) { throw Error("Bad hint" + (a ? ": " + a : "")); };
    H.push(["jsl", function(a) {
        for (var b in a)
            if (x(a, b)) { var c = a[b]; "object" == typeof c ? F[b] = v(F, b, []).concat(c) : v(F, b, c) }
    ...
    var Xa = /^(\/[a-zA-Z0-9_\-]+)+$/,
        ...
        cb = /\/cb=/g,
        bb = /\/\//g,
        jb = function() { var a = La(ea.href); if (!a) throw Error("Bad hint"); return a };
    ...
    var kb = decodeURI("%73cript"),
        ...
        nb = function() { var a = F.nonce; return void 0 !== a ? a && a === String(a) && a.match(lb) ? a : F.nonce = null : t.querySelector ? (a = t.querySelector("script[nonce]")) ? (a = a.nonce || a.getAttribute("nonce") || "", a && a === String(a) && a.match(lb) ? F.nonce = a : F.nonce = null) : null : null },
        pb = function(a) {
        ...
        tb = function(a, b,
            ...
            var n = v(Pa(c), "L", []).sort(),
                ...
                u = function(a, b) {
                    ...
                    if (b) { Va("me0", a, r); try { sb(b, c, k) } finally { Va("me1", a, r) } }
                    return 1
                };
            ...
            if (y.length) {
                ...
                E[I] = function(a) {
                    ...
                    0 < I && E[I - 1] ? E[I] = function() { b(c) } : b(c)
                };
                if (y.length) {
                    var Aa = "loaded_" + F.I++;
                    B[Aa] = function(a) {
    ...
    var rb = function(a, b) { if (F.hee && 0 < F.hel) try { return a() } catch (c) { b && b(c), F.hel--, K("debug_error", function() { try { window.___jsl.hefn(c) } catch (d) { throw c; } }) } else try { return a() } catch (c) { throw b && b(c), c; } };
    B.load = function(a, b) { return rb(function() { return K(a, b) }) };
    var L = function(a) {
    ...
    var Ab = { apppackagename: 1, callback: 1, clientid: 1, cookiepolicy: 1, openidrealm: -1, includegrantedscopes: -1, requestvisibleactions: 1, scope: 1 },
        Bb = !1,
        Cb = w(),
        Db = function() {
            if (!Bb) {
                ...
                if (window.self !== window.top) { a = document.location.toString(); for (var e in Ab) 0 < Ab[e] && (b = C(a, e, "")) && (Cb[e] = b) }
                Bb = !0
            }
            e = w();
            z(Cb, e);
        ...
        Eb = function(a) { return !!(a.clientid && a.scope && a.callback) };
    var Fb = window.console,
        Gb = function(a) { Fb && Fb.log && Fb.log(a) };
    var Hb = function() { return !!F.oa },
        Ib = function() {};
    var P = v(F, "rw", w()),
        Jb = function(a) { for (var b in P) a(P[b]) },
        Kb = function(a, b) {
    ...
    var Qb, Q, R = void 0,
        ...
        qc = function(a) { if (-1 !== Q) return oc(), R ? m.JSON.stringify.call(m.JSON, a) : U(a) },
    ...
    var vc = function() { this.J = new V };
    vc.prototype.reset = function() { this.J.reset() };
    var wc = q.crypto,
        xc = !1,
        yc = 0,
        zc = 0,
    ...
    var Hc = function() {
        ...
        Ic = function(a, b) { b = b.onload; return "function" === typeof b ? (Hc().a(a, b), b) : null },
        Jc = function(a) {
            A(/^\w+$/.test(a), "Unsupported id - " + a);
            Hc();
            return 'onload="window.___jsl.onl.e(&#34;' + a + '&#34;)"'
        },
        Kc = function(a) { Hc().r(a) };
    var Lc = { allowtransparency: "true", frameborder: "0", hspace: "0", marginheight: "0", marginwidth: "0", scrolling: "no", style: "", tabindex: "0", vspace: "0", width: "100%" },
        Mc = { allowtransparency: !0, onload: !0 },
        Nc = 0,
        Oc = function(a) { A(!a || Da.test(a), "Illegal url for new iframe - " + a) },
        Pc = function(a, b, c, d, e) {
            Oc(c.src);
            var f, g = Ic(d, c),
                h = g ? Jc(d) : "";
            try { document.all && (f = a.createElement('<iframe frameborder="' + pa(String(c.frameborder)) + '" scrolling="' + pa(String(c.scrolling)) + '" ' + h + ' name="' + pa(String(c.name)) + '"/>')) } catch (l) {} finally {
                f ||
    ...
    var Qc = /^:[\w]+$/,
        ...
        Sc = function() {
            ...
            return Lb = { socialhost: f, ctx_socialhost: d ? g : f, session_index: a, session_delegate: b, session_prefix: c, im_prefix: e }
        },
        Tc = function(a, b) { return Sc()[b] || "" },
        Uc = function(a) {
            return function(b,
                c) { return a ? Sc()[c] || a[c] || "" : Sc()[c] || "" }
        };
    var Vc = function(a) {
            var b;
    ...
    var Xc = { se: "0" },
        ...
        dd = function(a) { var b = void 0; "number" === typeof a ? b = a : "string" === typeof a && (b = parseInt(a, 10)); return b },
        gd = function() {
            var a = F.drw;
            Jb(function(b) {
    ...
    id = v(F, "FW", []);
    jd = null;
    var nd = function(a, b) { md(void 0, !1, a, b) },
        md = function(a, b, c, d) {
            G("ps0", !0);
            ...
            G("ps1", !0);
            if ((r = id.join(":")) || a) try { B.load(r, a) } catch (E) { Gb(E); return }
            if (od(jd || {}))
                for (var y in c) {
                    a =
                        c[y];
        ...
        sd = function(a) {
            var b = v(B, a, {});
            b.go || (b.go = function(b) { return nd(b, a) }, b.render = function(b, d) {
                d = d || {};
                d.type = a;
                return fd(b, d)
            })
    ...
    var pd = function(a, b) {
                ...
                case 1:
                    if (b.parentNode) {
                        for (var h in c) {
                            ...
                            if (f) try { c[h] = qc(c[h]) } catch (y) { delete c[h] }
                        }
                        f = !0;
                        c.dontclear && (f = !1);
                        delete c.dontclear;
        ...
        wd = function(a, b, c) {
            if (a && 1 === a.nodeType && b) {
                ...
                } else { if (hd[b]) return 0; if (W[b]) return 1 }
            }
            return null
        },
        fd = function(a, b) {
    ...
    rd = function(a, b) { xd(a, b) };
    var Ga = function(a) { md(a, !0) },
        yd = function(a, b) { b = b || []; for (var c = 0; c < b.length; ++c) a(b[c]); for (a = 0; a < b.length; a++) sd(b[a]) };
    ...
    var Ad = /^\{h:'/,
        ...
        Cd = "",
        xd = function(a, b) {
            function c() { Ea("message", d, "remove", "de") }
    ...
    Fd.prototype.read = function() { for (var a = this.H + "=", b = document.cookie.split(/;\s*/), c = 0; c < b.length; ++c) { var d = b[c]; if (0 == d.indexOf(a)) return d.substr(a.length) } };
    ...
    Fd.prototype.clear = function() { this.write("", 0) };
    ...
    var Id = function(a) { this.A = a },
        Y = {};
    Id.prototype.read = function() { if (Y.hasOwnProperty(this.A)) return Y[this.A] };
    Id.prototype.write = function(a) { Y[this.A] = a; return !0 };
    Id.prototype.clear = function() { delete Y[this.A] };
    Id.iterate = function(a) { for (var b in Y) Y.hasOwnProperty(b) && a(b, Y[b]) };
    var Jd = "https:" === window.location.protocol,
        ...
        Md = function() {
            var a, b = null;
            Kd.iterate(function(c, d) { 0 === c.indexOf("G_AUTHUSER_") && (c = Ld(c.substring(11)), !a || c.i && !a.i || c.i == a.i && c.l > a.l) && (a = c, b = d) });
            return { X: a, D: b }
        };
    var Nd = function(a) {
    ...
    var Z = function() { this.M = Rd };
    Z.prototype.v = 0;
    Z.prototype.K = 2;
    Z.prototype.M = null;
    Z.prototype.G = !1;
    Z.prototype.U = function() { this.G || (this.v = 0, this.G = !0, this.S()) };
    Z.prototype.S = function() { this.G && (this.M() ? this.v = this.K : this.v = Math.min(2 * (this.v || this.K), 120), window.setTimeout(ca(this.S, this), 1E3 * this.v)) };
    for (var Sd = 0; 64 > Sd; ++Sd);
    var Td = null;
    Hb = function() { return F.oa = !0 };
    Ib = function() {
        F.oa = !0;
        var a = Qd();
